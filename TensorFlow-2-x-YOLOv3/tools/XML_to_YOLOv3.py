...
data_dir = '/OIDv4_ToolKit/OID/Dataset_1000/' #Change HERE
Dataset_names_path = "model_data/Thesis8_1000_names.txt" #Change HERE
Dataset_train = "model_data/Thesis8_1000_train.txt" #Change HERE
Dataset_test = "model_data/Thesis8_200_test.txt" #Change HERE
is_subfolder = True
