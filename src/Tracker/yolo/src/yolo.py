...
class object_detector:
    ...
    def callback(self):
        ...
        _ , bboxes=detect_image(self.yolo, cv_image, "", input_size=YOLO_INPUT_SIZE, show=False,CLASSES=TRAIN_CLASSES,score_threshold=0.3, iou_threshold=0.3, rectangle_colors=(255,0,0))
